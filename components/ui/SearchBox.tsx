...
const SearchBox = ({
  ...
  return (
    ...
    >
      <label htmlFor="search_box" className="py-[1.56rem]">
      ...
      <input
        ...
        className="h-full w-full border-none outline-none focus:outline-none font-neue-montreal-medium tracking-[0.1rem] text-xl text-white placeholder:text-white"
      />
    </div>
  );
};
